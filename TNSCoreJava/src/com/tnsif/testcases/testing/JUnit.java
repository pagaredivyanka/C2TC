 ...
 * Types -> 1. Black Box 2. White Box 
 ...
 In JUnit 5 test life cycle is driven by 4 primary annotation 
 @BeforeAll -> when we annotate method with @BeforeAll then it executed before all tests in the current test class
 @BeforeEach -> annotation method should be executed before each test in the current test class
 	ex. variable re-initialization
 @AfterAll -> when we annotate method with @AfterAll then it executed after all tests in the current test class
 @AfterEach -> annotation method should be executed after each test in the current test class
